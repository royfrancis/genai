...
|---|---|---|
[ellmer](https://ellmer.tidyverse.org/)|all|query,chat,text->image,vision|
|[vitals](https://vitals.tidyverse.org/)|all|Benchmark LLMs|
|[mall](https://mlverse.github.io/mall/)|all|NLP using LLMs|
...
|---|---|---|
|[ChatGPT](https://chatgpt.com/)|Text to Image|Basic|
